...
_LIB_PATH = Path(__file__).with_name("libPlayerOneCamera.3.9.0.dylib")
dll = cdll.LoadLibrary(str(_LIB_PATH)) # Mac OS, please copy the 4 'dylib' files from 'lib' folder
...
class POAConfig(Enum):                  
    ...
    POA_WB_R = 4                        # red channel of white balance, percentage: [1, 100]%, read-write
    POA_WB_G = 5                        # green channel of white balance, percentage: [1, 100]%, read-write
    POA_WB_B = 6                        # blue channel of white balance, percentage: [1, 100]%, read-write
